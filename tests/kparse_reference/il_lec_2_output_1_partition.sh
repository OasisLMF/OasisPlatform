...
kat fifo/il_S1_eltcalc_P1 > output/il_S1_eltcalc.csv & pid331=$!
kat fifo/il_S1_pltcalc_P1 > output/il_S1_pltcalc.csv & pid332=$!
kat fifo/il_S1_summarycalc_P1 > output/il_S1_summarycalc.csv & pid333=$!
kat fifo/il_S2_eltcalc_P1 > output/il_S2_eltcalc.csv & pid334=$!
kat fifo/il_S2_pltcalc_P1 > output/il_S2_pltcalc.csv & pid335=$!
kat fifo/il_S2_summarycalc_P1 > output/il_S2_summarycalc.csv & pid336=$!
...
tee < fifo/il_S1_summary_P1 fifo/il_S1_summaryeltcalc_P1 fifo/il_S1_summarypltcalc_P1 fifo/il_S1_summarysummarycalc_P1 fifo/il_S1_summaryaalcalc_P1 work/il_S1_summaryleccalc/P1.bin  > /dev/null & pid339=$!
tee < fifo/il_S2_summary_P1 fifo/il_S2_summaryeltcalc_P1 fifo/il_S2_summarypltcalc_P1 fifo/il_S2_summarysummarycalc_P1 fifo/il_S2_summaryaalcalc_P1 work/il_S2_summaryleccalc/P1.bin  > /dev/null & pid340=$!
