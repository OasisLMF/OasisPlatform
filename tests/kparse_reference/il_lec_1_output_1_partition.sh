...
kat fifo/il_S1_eltcalc_P1 > output/il_S1_eltcalc.csv & pid319=$!
kat fifo/il_S1_pltcalc_P1 > output/il_S1_pltcalc.csv & pid320=$!
kat fifo/il_S1_summarycalc_P1 > output/il_S1_summarycalc.csv & pid321=$!
...
tee < fifo/il_S1_summary_P1 fifo/il_S1_summaryeltcalc_P1 fifo/il_S1_summarypltcalc_P1 fifo/il_S1_summarysummarycalc_P1 fifo/il_S1_summaryaalcalc_P1 work/il_S1_summaryleccalc/P1.bin  > /dev/null & pid323=$!
...
leccalc -r -Kil_S1_summaryleccalc
 ...
 -w output/il_S1_leccalc_wheatsheaf_oep.csv
  &  lpid23=$!
wait $apid1 $apid2 $apid3 $apid4 $apid5 $apid6 $apid7 $apid8 $apid9 $apid10 $apid11 $apid12 $apid13 $apid14 $apid15 $apid16 $apid17 $apid18 $apid19 $apid20 $apid21 $apid22 $apid23 $apid24 $apid25 $apid26 $apid27 $apid28 $apid29 $apid30 $apid31 $apid32 $apid33 $apid34 $apid35 $apid36 $apid37 $apid38 $apid39 $apid40 $apid41 $apid42 $apid43 

wait $lpid1 $lpid2 $lpid3 $lpid4 $lpid5 $lpid6 $lpid7 $lpid8 $lpid9 $lpid10 $lpid11 $lpid12 $lpid13 $lpid14 $lpid15 $lpid16 $lpid17 $lpid18 $lpid19 $lpid20 $lpid21 $lpid22 $lpid23 
