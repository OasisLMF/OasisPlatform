...
kat fifo/gul_S1_eltcalc_P1 > output/gul_S1_eltcalc.csv & pid295=$!
kat fifo/gul_S1_pltcalc_P1 > output/gul_S1_pltcalc.csv & pid296=$!
kat fifo/gul_S1_summarycalc_P1 > output/gul_S1_summarycalc.csv & pid297=$!
kat fifo/gul_S2_eltcalc_P1 > output/gul_S2_eltcalc.csv & pid298=$!
kat fifo/gul_S2_pltcalc_P1 > output/gul_S2_pltcalc.csv & pid299=$!
kat fifo/gul_S2_summarycalc_P1 > output/gul_S2_summarycalc.csv & pid300=$!
...
tee < fifo/gul_S1_summary_P1 fifo/gul_S1_summaryeltcalc_P1 fifo/gul_S1_summarypltcalc_P1 fifo/gul_S1_summarysummarycalc_P1 fifo/gul_S1_summaryaalcalc_P1  > /dev/null & pid303=$!
tee < fifo/gul_S2_summary_P1 fifo/gul_S2_summaryeltcalc_P1 fifo/gul_S2_summarypltcalc_P1 fifo/gul_S2_summarysummarycalc_P1 fifo/gul_S2_summaryaalcalc_P1  > /dev/null & pid304=$!
