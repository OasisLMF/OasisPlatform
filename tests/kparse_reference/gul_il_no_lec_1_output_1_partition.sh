...
kat fifo/il_S1_eltcalc_P1 > output/il_S1_eltcalc.csv & pid175=$!
kat fifo/il_S1_pltcalc_P1 > output/il_S1_pltcalc.csv & pid176=$!
kat fifo/il_S1_summarycalc_P1 > output/il_S1_summarycalc.csv & pid177=$!

# --- Do ground up loss kats ---

kat fifo/gul_S1_eltcalc_P1 > output/gul_S1_eltcalc.csv & pid178=$!
kat fifo/gul_S1_pltcalc_P1 > output/gul_S1_pltcalc.csv & pid179=$!
kat fifo/gul_S1_summarycalc_P1 > output/gul_S1_summarycalc.csv & pid180=$!
...
tee < fifo/il_S1_summary_P1 fifo/il_S1_summaryeltcalc_P1 fifo/il_S1_summarypltcalc_P1 fifo/il_S1_summarysummarycalc_P1 fifo/il_S1_summaryaalcalc_P1  > /dev/null & pid182=$!
...
tee < fifo/gul_S1_summary_P1 fifo/gul_S1_summaryeltcalc_P1 fifo/gul_S1_summarypltcalc_P1 fifo/gul_S1_summarysummarycalc_P1 fifo/gul_S1_summaryaalcalc_P1  > /dev/null & pid184=$!
...
aalsummary -Kil_S1_aalcalc > output/il_S1_aalcalc.csv & apid19=$!
aalsummary -Kgul_S1_aalcalc > output/gul_S1_aalcalc.csv & apid20=$!
wait $apid1 $apid2 $apid3 $apid4 $apid5 $apid6 $apid7 $apid8 $apid9 $apid10 $apid11 $apid12 $apid13 $apid14 $apid15 $apid16 $apid17 $apid18 $apid19 $apid20 
