...
kat fifo/gul_S1_eltcalc_P1 > output/gul_S1_eltcalc.csv & pid247=$!
kat fifo/gul_S1_pltcalc_P1 > output/gul_S1_pltcalc.csv & pid248=$!
kat fifo/gul_S1_summarycalc_P1 > output/gul_S1_summarycalc.csv & pid249=$!
...
leccalc -r -Kgul_S1_summaryleccalc
 ...
 -w output/gul_S1_leccalc_wheatsheaf_oep.csv
  &  lpid17=$!
wait $apid1 $apid2 $apid3 $apid4 $apid5 $apid6 $apid7 $apid8 $apid9 $apid10 $apid11 $apid12 $apid13 $apid14 $apid15 $apid16 $apid17 $apid18 $apid19 $apid20 $apid21 $apid22 $apid23 $apid24 $apid25 $apid26 $apid27 $apid28 $apid29 $apid30 $apid31 

wait $lpid1 $lpid2 $lpid3 $lpid4 $lpid5 $lpid6 $lpid7 $lpid8 $lpid9 $lpid10 $lpid11 $lpid12 $lpid13 $lpid14 $lpid15 $lpid16 $lpid17 
