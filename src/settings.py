...
class Settings(ConfigParser):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._ini_path = os.environ.setdefault('OASIS_API_INI_PATH', os.path.join(os.path.dirname(__file__), 'conf.ini'))
        os.environ.setdefault('OASIS_API_LOG_DIRECTORY', '/var/log/oasis')

        with io.open(self._ini_path, 'r', encoding='utf-8') as f:
            self.read_file(f)
