...
v2.conf.task_queues = [
    Queue('celery-v2', Exchange('celery-v2'), routing_key='celery-v2', queue_arguments={'x-max-priority': 10}),
    Queue('task-controller', Exchange('task-controller'), routing_key='task-controller', queue_arguments={'x-max-priority': 10}),
]
