...
#             @classmethod
#             #def get_generate_inputs_tasks_params(cls, analysis, initiator):
#             def get_inputs_generation_tasks(cls, analysis, initiator, run_data_uuid, num_chunks):
#                 return tuple(zip(
#                     [
#                         TaskParams('foo', bar='boo'),
...
#
#         with patch('src.server.oasisapi.analyses.v2_api.task_controller.chord', chord):
#         #with patch('src.server.oasisapi.analyses.v2_api.task_controller.chord', chord), \
#         #     patch('src.server.oasisapi.analyses.v2_api.task_controller.chain', chain):
#
#             MockController.generate_inputs(analysis, initiator, loc_lines=10)
#
