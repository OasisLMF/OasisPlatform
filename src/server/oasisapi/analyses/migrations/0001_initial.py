    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_generation_traceback_file', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='input_generation_traceback_analyses', to='files.RelatedFile')),
                ...
                ('run_traceback_file', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='run_traceback_file_analyses', to='files.RelatedFile')),
