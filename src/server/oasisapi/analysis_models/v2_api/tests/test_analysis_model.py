    ...
    def test_settings_json_is_not_valid___response_is_400(self):
        with TemporaryDirectory() as d:
            with override_settings(MEDIA_ROOT=d):
                ...
                validation_error = {
                    'model_settings_schema model_settings': ["Unevaluated properties are not allowed ('float_parameter' was unexpected)"],
                    'model_settings_schema model_settings-event_set': ["'desc' is a required property"],
                    'model_settings_schema model_settings-event_occurrence_id-default': ["1 is not of type 'string'"],
                    'model_settings_schema model_settings-boolean_parameters-0-default': ["1.1 is not of type 'boolean'"],
                    'model_settings_schema lookup_settings-supported_perils-0': ["Additional properties are not allowed ('i' was unexpected)", "'id' is a required property"],
                    'model_settings_schema lookup_settings-supported_perils-1': ["Additional properties are not allowed ('des' was unexpected)", "'desc' is a required property"],
                    'model_settings_schema lookup_settings-supported_perils-2-id': ["'WW11' is too long"]
                }
