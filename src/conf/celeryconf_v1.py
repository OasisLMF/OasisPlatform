...
CELERY_V1_RESULT_BACKEND = CELERY_RESULT_BACKEND
CELERY_V1_RESULTS_DB_BACKEND = CELERY_RESULTS_DB_BACKEND
CELERY_V1_BROKER_URL = BROKER_URL

#: Celery config - AMQP task result expiration time
CELERY_V1_AMQP_TASK_RESULT_EXPIRES = 1000

#: Celery config - task serializer
CELERY_V1_TASK_SERIALIZER = 'json'

#: Celery config - result serializer
CELERY_V1_RESULT_SERIALIZER = 'json'

#: Celery config - accept content type
CELERY_V1_ACCEPT_CONTENT = ['json']

#: Celery config - timezone (default == UTC)
# CELERY_V1_TIMEZONE = 'Europe/London'

#: Celery config - enable UTC
CELERY_V1_ENABLE_UTC = True
...
CELERY_V1_ACKS_LATE = True
CELERY_V1_REJECT_ON_WORKER_LOST = True

CELERY_V1_TASK_QUEUES = (Broadcast('model-worker-broadcast'), )

# Highest priority available
#CELERY_V1_QUEUE_MAX_PRIORITY = 10

# Set to make internal and subtasks inherit priority
#CELERY_V1_INHERIT_PARENT_PRIORITY = True

# Default Queue Name
#CELERY_V1_DEFAULT_QUEUE = "celery-v2"
...
# Default Queue Name
CELERY_V1_DEFAULT_QUEUE = "celery"
