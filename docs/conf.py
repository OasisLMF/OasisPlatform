# -*- coding: utf-8 -*-
#
# Oasis API documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'OasisAPI.tex', u'Oasis API Documentation',
...
man_pages = [
    (master_doc, 'oasisapi', u'Oasis API Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'OasisAPI', u'Oasis API Documentation',
     author, 'OasisAPI', 'One line description of project.',
     'Miscellaneous'),
]
