...
# README.md documents the convention, so it necessarily contains literal example markers;
# rewriting them would destroy the instructions. Anywhere else that explains the
# convention should link there rather than repeat the example on a line of its own.
