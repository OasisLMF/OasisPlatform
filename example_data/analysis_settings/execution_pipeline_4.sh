...
eve 1 5 | getmodel | gulcalc -S100 -R1000000 -c ./work/1/gul -i - | fmcalc | ./work/1/il
eve 2 5 | getmodel | gulcalc -S100 -R1000000 -c ./work/2/gul -i - | fmcalc | ./work/2/il
eve 3 5 | getmodel | gulcalc -S100 -R1000000 -c ./work/3/gul -i - | fmcalc | ./work/3/il
eve 4 5 | getmodel | gulcalc -S100 -R1000000 -c ./work/4/gul -i - | fmcalc | ./work/4/il
eve 5 5 | getmodel | gulcalc -S100 -R1000000 -c ./work/5/gul -i - | fmcalc | ./work/5/il
